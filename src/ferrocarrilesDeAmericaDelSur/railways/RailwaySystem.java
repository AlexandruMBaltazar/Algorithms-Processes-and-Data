...
public class RailwaySystem {
	...
	private Clock clock; // the clock used to time railways - must be initialised for each run
	 ...
	 * @throws RailwaySystemError if the railway system or the railways are interrupted.
	 */
	 ...
	 */
	public Railway getNextRailway() throws ProgrammingError {
